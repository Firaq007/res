...
openai.api_key = "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"
...
async def create_file(file: UploadFile = File(...)):
    ...
    with open(read_file, "r",encoding="utf8") as f:
        ...
        K=Content.replace(k, '')
        D=K.split()[:500]
        prompt="Fill the following fields  #1 candidate name: #2 phone number:,#3 email id:, #4: Previous Job & Company Name,#5 Graduation College: , from the following resume and please leave the field blank if it doesn't exist "+D
